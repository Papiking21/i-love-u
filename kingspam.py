...
|_|         |_|                   |___/
	...
	def AlfaMart(Phone, Amount):
		for _ in range(Amount):
			...
			headers = {
			'User-Agent' : 'Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; rv:11.0) like Gecko',
			'Referer' : 'https://www.indihome.co.id/verifikasi-layanan/login-otp'
			}
		
			data = {
			'fullName' : 'Yt papi king21',
	...
	def Spam():
		...
		Tik(C+50*'=')
		Tik(C+'['+W+'2'+C+']'+W+' SPAM OTP HOOQ'+W+'\tBELUM TAU'+W+'\tDICOBA'+H+' \xE2\x9C\x94')
		Tik(C+50*'=')
		Tik(C+'['+W+'3'+C+']'+W+' SPAM OTP HARVEST'+W+'\t6X / 1 HARI'+W+'\tACTIVE'+H+' \xE2\x9C\x94')
		Tik(C+50*'=')
		Tik(C+'['+W+'4'+C+']'+W+' SPAM OTP OLX'+W+'\tUNLIMITED'+W+'\tCOID'+H+' \xE2\x9C\x94')
		Tik(C+50*'=')
		Tik(C+'['+W+'5'+C+']'+W+' SPAM OTP TOKOPEDIA'+W+'\t3X / 1 HARI'+W+'\tCOBA'+H+' \xE2\x9C\x94')
		Tik(C+50*'=')
		Tik(C+'['+W+'6'+C+']'+W+' SPAM OTP ALFAMART'+W+'\t4X / 1 HARI'+W+'\tCOBA'+H+' \xE2\x9C\x94')
		Tik(C+50*'=')
		...
		if PilihTools == '1':
			...
			try:
				...
				print
				print(M+'SINYAL LU JELEK TELASO:V !')
				sys.exit()
		
		elif PilihTools == '9':
			os.system('xdg-open http://wa.me/085697750717?text=Hallo')
...
if __name__ == '__main__':
	print(C+'Subscribe YT'+W+' Gua Dlu Ya OM !'+C+' :V')
	sleep(2)
	os.system('clear')
	os.system('xdg-open https://youtube.com/channel/UClBmb0PBsTmCFNwkPz64NFg')
	sleep(7)
	Spam()
